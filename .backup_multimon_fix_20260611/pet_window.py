...
from PySide6.QtGui import QColor, QIcon, QCursor, QGuiApplication, QMoveEvent, QResizeEvent, QPainter, QPen, QBrush, QFont, QFontMetrics
...
class PetWindow(QWidget):
    ...
    def _ensure_radial_menu(self) -> RadialMenu:
        ...
        radial_menu.add_item(
            "", _tr("PetWindow.radial_reset"), QColor(255, 140, 0),
            glyph="\U0001F4CD",
            on_click=self._on_radial_reset_position,
        )
