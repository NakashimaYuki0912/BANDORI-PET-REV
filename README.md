...
> **下载模型包**（必需）：[zstd 压缩包 ~900MB](https://modelscope.cn/datasets/HELPMEEADICE/BanG-Dream-Live2D/resolve/master/models.zip)（推荐）或 [7z 完整包 ~4GB](https://modelscope.cn/datasets/HELPMEEADICE/BanG-Dream-Live2D/resolve/master/models.7z)，下载后解压 `models/` 到项目根目录。
